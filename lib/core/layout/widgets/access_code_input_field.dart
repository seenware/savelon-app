...
class AccessCodeInputField extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final shakeAnimation = TweenSequence<double>([
      ...
      TweenSequenceItem(
        tween: Tween<double>(begin: -10, end: 10).chain(
          CurveTween(curve: Curves.easeInOut),
        ),
        weight: 2,
      ),
      TweenSequenceItem(
        tween: Tween<double>(begin: 10, end: -6).chain(
          CurveTween(curve: Curves.easeInOut),
        ),
        weight: 1.5,
      ),
      TweenSequenceItem(
        tween: Tween<double>(begin: -6, end: 6).chain(
          CurveTween(curve: Curves.easeInOut),
        ),
        weight: 1,
      ),
      TweenSequenceItem(
        tween: Tween<double>(begin: 6, end: 0).chain(
          CurveTween(curve: Curves.easeOut),
        ),
        weight: 1,
      ),
